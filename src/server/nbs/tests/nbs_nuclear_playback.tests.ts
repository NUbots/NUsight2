...
describe('NbsNUClearPlayback', () => {
  it('plays packets at correct', () => {
    ...
    clock.runTimersToTime(1009) // Should have sent packet yet at only 9 elapsed seconds
    ...
    clock.runTimersToTime(1019) // Should have sent packet yet at only 19 elapsed seconds
