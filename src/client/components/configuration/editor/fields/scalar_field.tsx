...
@observer
export class ScalarField extends React.Component<FieldProps> {
  public render(): JSX.Element {
    const field = this.props.data
    return (
      <label className={style.scalarField + ' ' + editorStyle.editorLine}>
        <span className={style.scalarField__label}>{ this.props.data.name }</span>
