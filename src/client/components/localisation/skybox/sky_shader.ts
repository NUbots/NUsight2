...
export class SkyShader {
  ...
  @observable public vertexShader: string
  @observable public fragmentShader: string
  ...
  constructor() {
    ...
    this.fragmentShader = [
      ...
      '	Lin *= mix( vec3( 1.0 ), pow( vSunE * ( ( betaRTheta + ' +
      'betaMTheta ) / ( vBetaR + vBetaM ) ) * Fex, vec3( 1.0 / 2.0 ) ),' +
